	 ...
	 <%
		...
		<div class="col-4">
			...
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="1" class="btn">Add to cart</button>
			</form>
		...
		<div class="col-4">
			...
			<p>$10,911.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="2" class="btn">Add to cart</button>
			</form>
		</div>
	</div>
	<div class="row">
		<div class="col-4">
			...
			<p>$28,062.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="3" class="btn">Add to cart</button>
			</form>
		</div>
		<div class="col-4">
			...
			<p>$10,099.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="4" class="btn">Add to cart</button>
			</form>
		</div>
		...
		<div class="col-4">
			...
			<p>$55,130.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="5" class="btn">Add to cart</button>
			</form>
		</div>
		<div class="col-4">
			...
			<p>$17,599.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="6" class="btn">Add to cart</button>
			</form>
		</div>
		<div class="col-4">
			...
			<p>$60,723.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="7" class="btn">Add to cart</button>
			</form>
		</div>
		<div class="col-4">
			...
			<p>$7,899.00</p>
			<form action="add_to_cart" method="post">
			   <button type="submit" name="id" value="8" class="btn">Add to cart</button>
			</form>
		</div>
	</div>
	<div class="page-btn">
		<a href="product.jsp" ><span style="background:#19a500;">1</span></a>
		<a href="product2.jsp"><span>2</span></a>
		<a href="product2.jsp"><span>&#8594;</span></a>
	</div>
</div>
<!-- footer -->
<div class="footer">
